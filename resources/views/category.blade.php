                ...
                <div class="categories_list shadow">
                    ...
                    <ul>
                        @if ($category->parent != '0')
                            <li><a
                                    href="{{ url('/store/category/' . $category->getParent->id . '/' . $category->getParent->slug) }}">Regresar
                                    a {{ $category->getParent->name }}</a></li>
                        @endif
                        @if ($category->parent == '0')
                            <li><a href="{{ url('/store/category/' . $category->id . '/' . $category->slug) }}">Regresar a
                                    {{ $category->name }}</a></li>
                        @endif
